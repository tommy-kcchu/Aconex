...
public class FileProcessorTest {
	...
	public void testPhoneNumberWithSpecialChar() throws IOException {
		...
		Map<String, List<String>> result = fileProcessor.processPhoneNumberWithDictionary(Arrays.asList(phone), dictionary);
		/**
